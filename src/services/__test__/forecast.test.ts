...
describe('Forecast Service', () => {
  ...
  it('should return the forecast for a list of branches', async () => {
    mockedStormGlassService.fetchPoints.mockResolvedValue(
      stormGlassNormalizedFixture
    );
    const beaches: Beach[] = [
      {
        lat: -33.792726,
  ...
  it('should be return an empty list when the beaches array is empty', async () => {
